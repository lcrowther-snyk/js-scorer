...
|--------|-------|
| Total findings | 253 |
| Excluded (path filter) | 193 |
| Informational (CWE filter) | 7 |
| In-scope findings | 53 |
...
| CWE-798 | 0 | 6 | 3 | 0.0000 | 0.0000 | n/a |
...
| `javascript/HTTPSourceWithUncheckedType` | `routes/profileImageUrlUpload.ts` | 28 | CWE-1287 |
| `javascript/NoHardcodedPasswords/test` | `frontend/src/app/Services/two-factor-auth-service.spec.ts` | 65 | CWE-259, CWE-798 |
| `javascript/NoHardcodedPasswords/test` | `frontend/src/app/Services/two-factor-auth-service.spec.ts` | 81 | CWE-259, CWE-798 |
| `javascript/NoHardcodedPasswords/test` | `frontend/src/app/oauth/oauth.component.spec.ts` | 84 | CWE-259, CWE-798 |
| `javascript/NoHardcodedPasswords/test` | `frontend/src/app/oauth/oauth.component.spec.ts` | 91 | CWE-259, CWE-798 |
| `javascript/NoHardcodedPasswords/test` | `frontend/src/app/oauth/oauth.component.spec.ts` | 84 | CWE-259, CWE-798 |
...
These 7 findings have only informational CWEs (CWE-319, CWE-547) and are excluded from scoring.
...
| `javascript/HardcodedNonCryptoSecret/test` | `frontend/src/app/app.guard.spec.ts` | 38 | CWE-547 |
| `javascript/HardcodedNonCryptoSecret/test` | `frontend/src/app/last-login-ip/last-login-ip.component.spec.ts` | 61 | CWE-547 |

## Exclusion summary

193 findings excluded by path filters (per-pattern counts may overlap):
